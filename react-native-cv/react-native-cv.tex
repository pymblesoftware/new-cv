...
\textbf{Recent} \\
Academic projects, Business projects, Personal software projects, very short-term and problematic freelance projects in a multitude of platforms, from Java SpringBoot, Flutter, ReactNative, \textbf{TypeScript}, node.js, Swift/iOS, Kotlin/Android, Ethereum/Solidity, Rust, and Solana.   \\
...
\textbf{Flutter}, Kotlin (Android), AWS CloudWatch, S3, node.js Lambdas, \textbf{TypeScript}, DynamoDB, \\ 
Azure DevOps  \\
