...
Technologies:	C++, Solaris, Windows. Sybase, Sunsoft C++, Cytrix, Borland C++ Builder, Java, PERL/Tk, Tools++, DBTools++, GreenLeaf Comm++, \textbf{SNA} \Cfootnote[blue]{https://bitsavers.org/pdf/ibm/sna/GA27-3102-0\_SNA\_General\_Information\_Jan75.pdf}, \textbf{LU-62}, Systematics
...
Server-side: a modified form of DES (CREEP), an interface to other internal applications in the bank including updates to FOREX (FOReign EXchange) rate boards in the branches, \textbf{connections to a Screen Scraper for communication to the IBM 3090 MVS mainframes via LU6.2 bridges}.
